...
import utils.tensorrt.inference_trt as inference_utils 
...
def parse_args():
    ...
    # Network
    parser.add_argument('--onnx', type=str,default = "onnx_files/dsc_rdbd_1_sim.onnx",
                        help='Dataset Name ("cornell" or "jaquard")')
    parser.add_argument('--trt', type=str,default = "onnx_files/dsc_rdbd_1_sim.trt",
                        help='Dataset Name ("cornell" or "jaquard")')
