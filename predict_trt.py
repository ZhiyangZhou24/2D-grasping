...
import numpy as np
import cv2
import utils.tensorrt.inference_trt as inference_utils  # TRT/TF inference wrappers
...
if __name__ == "__main__":
    ...
    # batch size = 1
    max_batch_size = 1
    engine_file_path = "onnx_files/dsc_rdbd_sim.trt"
    onnx_file_path = "onnx_files/dsc_rdbd_sim.onnx"
    ...
    # 2. 图像预处理
    rgb_path = "/media/lab/e/zzy/datasets/Cornell/01/pcd0101r.png"
    depth_path = "/media/lab/e/zzy/datasets/Cornell/01/pcd0101d.tiff"
