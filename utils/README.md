...
```bash
python train_network.py --dataset cornell --dataset-path /media/lab/d/ZZY/datasets/Cornell --description training_cornell
```
...
```bash
python evaluate.py --network trained-models/cornell-randsplit-rgbd-grconvnet3-drop1-ch32/epoch_19_iou_0.98 --dataset cornell --dataset-path /media/lab/d/ZZY/datasets/Cornell --iou-eval --vis
```
