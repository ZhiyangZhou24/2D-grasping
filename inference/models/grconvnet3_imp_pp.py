...
class GenerativeResnet(GraspModel):
    ...
    def __init__(self, input_channels=4, output_channels=1, channel_size=32, dropout=False, prob=0.0):
        ...
        self.conv2 = DepthwiseSeparable(channel_size,channel_size * 2,stride = 2,use_se=True)
        ...
        self.conv3 = DepthwiseSeparable(channel_size * 2,channel_size * 4,stride = 2,use_se=True)
        ...
        self.res1 = ResidualBlock(channel_size * 4, channel_size * 4, use_att=False) #128 56
        self.res2 = ResidualBlock(channel_size * 4, channel_size * 4, use_att=False) #128 56
        self.res3 = ResidualBlock(channel_size * 4, channel_size * 4, use_att=False) #128 56
        self.res4 = ResidualBlock(channel_size * 4, channel_size * 4, use_att=False) #128 56
        self.res5 = ResidualBlock(channel_size * 4, channel_size * 4, use_att=False) #128 56
